  ...
  const pricingPlans = [
    {
      ...
      features: [
        ...
        "Up to 3 patents per month",
      ],
      limitations: [
        "Single jurisdiction (India only)",
        "Up to 10 claims",
    ...
    },
    {
      ...
      features: [
        ...
        "Multi-jurisdiction support (India, US, EU)",
        "Phone & chat support",
        "3 revisions included",
        "Advanced compliance checking",
        "Drawing generation assistance",
        "Patent landscape analysis",
        "Up to 30 patents per month",
      ],
  ...
  const faqs = [
    {
      ...
      answer:
        "You pay a monthly subscription fee that allows you to create patents up to your plan's limit. This includes AI drafting, prior art search, compliance checking, and filing preparation.",
    },
    {
      question: "What's included in the base price?",
      answer:
        "Each plan includes AI-powered patent drafting, prior art search, filing preparation, and support. Higher tiers include more jurisdictions, additional patents per month, and premium features.",
    },
    {
      question: "Can I upgrade my plan after starting?",
      answer:
        "Yes! You can upgrade to a higher tier at any time. Your new benefits will be available immediately upon upgrading.",
    },
    {
      question: "Do you offer refunds?",
      answer:
        "We offer a 30-day money-back guarantee if you're not satisfied with our AI-generated patent drafts.",
    },
    {
      question: "How long does the patent process take?",
      answer:
        "Our AI generates initial drafts within hours. The complete patent preparation process typically takes a few days depending on complexity and revisions needed.",
    },
    {
      question: "Is there a volume discount?",
      answer:
        "Yes! Our Business plan offers custom pricing for higher volume needs. Contact our sales team for details.",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6 text-balance">
              ...
              <span className="text-primary">Every Innovation</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
              Monthly plans with no hidden fees. Choose the plan that fits your
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="font-bold text-foreground">PatentAI</span>
            </div>
            <p className="text-sm text-muted-foreground">
              © PatentAI. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
